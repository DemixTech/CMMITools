...
namespace BASE2
{
    public class Schedule2
    {
        ...
        public void Schedule2Add(Worksheet schWks, int row)
        {
            ...
            try
            {
                sValue2 = schWks.Cells[row, 1].ToString();//.Value; // WorkID field
                ...
                sValue2 = schWks.Cells[row, 3].ToString();//.Value; // PA
                if (string.IsNullOrEmpty(sValue2))
                {
                ...
                sValue2 = schWks.Cells[row, 4].ToString();//.Value; // Participant Name
                if (string.IsNullOrEmpty(sValue2))
                {
                ...
                sValue2 = schWks.Cells[row, 5].ToString(); //.Value; // Role
                if (string.IsNullOrEmpty(sValue2))
                {
                ...
                sValue2 = schWks.Cells[row, 8].ToString();// .Value; // PA
                if (string.IsNullOrEmpty(sValue2))
                {
