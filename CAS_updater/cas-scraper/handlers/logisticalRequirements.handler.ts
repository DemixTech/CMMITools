...
cls.prototype.handleLogisticalRequirementsPage = async function(): Promise<void> {
  ...
  try {
    ...
    const colConfig = JSON.stringify([["A","requirement","inline"],["B","equipment","inline"],["C","other","inline"],["D","description","inline"],["E","role","inline"]]);
    const rowsData  = JSON.stringify(blocks);
