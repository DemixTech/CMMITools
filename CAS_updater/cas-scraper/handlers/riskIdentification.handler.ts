...
cls.prototype.handleRiskIdentificationPage = async function(): Promise<void> {
  ...
  try {
    ...
    // B=category(ss), E=impact(ss), G=status(ss) are dropdowns; rest are free text
    const colConfig = JSON.stringify([["A","name","inline"],["B","category","ss"],["C","otherCategory","inline"],["D","description","inline"],["E","impact","ss"],["F","mitigation","inline"],["G","status","ss"]]);
